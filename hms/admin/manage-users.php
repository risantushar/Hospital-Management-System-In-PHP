...
function fetch_data()  
 {  
      $output = '';  
      $conn = mysqli_connect("localhost", "risantushar", "risantushar#*", "hms.");  
 ...
 {  
      ...
      $obj_pdf->SetTitle("Appointment PDF List");  
      ...
      $content = '';  
      $content .= '  
      <h4 align="center">Ren-Hospital Patient Appointment List in PDF Formate</h4><br /> 
      <h3 align="center">REN HOSPITAL</h3>
			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<!-- PDF GENERATE BUTTON START -->
						<div style="float: right;">
							<form method="post">  
                          <input type="submit" name="generate_pdf" class="btn btn-success" value="Generate PDF" />  
                     </form>  
						</div>
						<!-- PDF GENERATE BUTTON END -->

			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
								...
								<div class="col-md-12">
									...
									<div class="row margin-top-30">
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white" style="margin-left:300px;border:2px solid #5FBC4C;">
													...
													<form role="form" name="adddoc" method="post" onSubmit="return valid();">
														<div class="form-group">
															<label for="DoctorSpecialization">
																...
																<i style="font-size:18px;" class="fa fa-chevron-circle-down"></i>																															
																		<?php 
						...
						<button style="margin-left:180px" type="submit" name="submit" class="btn btn-o btn-success">Submit</button>
													</form>
												</div>
											</div>
										</div>
